                        ...
                        for( var i =0; i< res.list.length;i++){
                            var qhtml = ''
                                qhtml += '<tr>'+
                                    ...
                                    '<td><div class="td-bg">'+res.list[i].studentname+'</div>'+
                                    '</td><td><div class="td-bg">'+res.list[i].classname+'</div>'+
                                    '</td>'+
                                    '<td><div class="td-bg">'+res.list[i].birthday+'</div></td>'+
                                    '<td><div class="td-bg">'+res.list[i].sex+'</div></td>'+
                                    '<td><div class="td-bg"><a href="student-details.html?studentid='+res.list[i].studentid+'">查看详情</a></div></td>'+
                                    '</tr>';
