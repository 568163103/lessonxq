                        ...
                        for( var i =0; i< res.list.length;i++){
                            var qhtml = ''
                                qhtml += '<tr>'+
                                    ...
                                    '<td title='+res.list[i].schoolname+'><div class="td-bg al">'+res.list[i].schoolname+'</div></td>'+
                                    '<td><div class="td-bg">'+res.list[i].city_name+'</div></td>'+
                                    '<td><div class="td-bg">'+res.list[i].district_name+'</div></td>'+
                                    '<td><div class="td-bg">私立</div></td>'+
                                    '<td><div class="td-bg"></div></td>'+
                                    '<td><div class="td-bg">100%</div></td>'+
                                    '<td><div class="td-bg">100%</div></td>'+
                                    '<td><div class="td-bg">'+res.list[i].male+':'+res.list[i].female+'</div></td>'+
                                    '<td><div class="td-bg"><a href="teacher-detail.html?schoolid='+res.list[i].schoolid+'">查看详情</a></div></td>'+
                                    '</tr>';
