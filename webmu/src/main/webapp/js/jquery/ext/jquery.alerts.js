...
(function($) {
	...
	$.alerts = {
		...
		promptcopy: function(message, value, title, callback) {
			if( title == null ) title = 'Prompt';
			$.alerts._show(title, message, value, 'promptcopy', function(result) {
				if( typeof(callback)=="function" ) callback(result);
			});
		},
	...
	jPromptcopy = function(message, value, title, callback) {
		$.alerts.promptcopy(message, value, title, callback);
	};
	...
	window.JConfirm=function(message,callback){
		jConfirm(message,'\u63d0\u793a\u4fe1\u606f',callback);
	};
	window.JPrompt=function(message,callback){
		jPrompt(message,'\u63d0\u793a\u4fe1\u606f',callback);
	};
})(jQuery);