...
<head>
	...
	<script type="text/javascript">
		var currChannelId = null,currChannelName = null,$playerIframe = null,currNode = null,currIndex = -1;
...
<div class="win-header" id="a" style="min-width: 1660px">
	<span class="win-header-title"><c:if test="${param.m eq '1'}">地图模式</c:if><c:if test="${param.m ne '1'}">视频浏览</c:if> &gt; 实时视频</span>
...
<div class="win-bodyer" style="min-width: 1340px">
		<table width="99%" class="inputTable" border="0">
			<tr>
				<td id="leftTree" align="center" style="width:355px;height:98%;" rowspan="2">
