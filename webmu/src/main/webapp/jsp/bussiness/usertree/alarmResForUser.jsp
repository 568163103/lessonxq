...
<script type="text/javascript">
	...
	function getUserGroups(currTr,uid){
		...
		$('#uid').val(uid);
		$.post("${ctx}/bussiness/usertree!beforeAlarmResForUser.do?uid="+uid,function(data){
	...
	function submitAuthGroupForUser(){
		getGids();
		$.post("${ctx}/bussiness/usertree!authAlarmResForUser.do",$("#groupsPageForm").serializeArray(),function(data){
			if(data && "ok"==data){
				alert("保存成功！")
			} else {
				alert("保存失败！")
...
<body class="main_bg">
	<div class="win-header" id="a">
		<span class="win-header-title">业务管理 &gt; 用户网管告警资源订阅</span>
	</div>
			...
			<tr>
				...
				<td>
					<fieldset style="width: 100%;height: 790px;">
						<legend>&nbsp;&nbsp;点击左侧用户分配告警资源&nbsp;&nbsp;</legend>
						<form id="groupsPageForm" name="pageForm" action="${ctx}/bussiness/usertree!alarmResForUser.do" method="post">
