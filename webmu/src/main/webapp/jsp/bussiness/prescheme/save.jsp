...
<script type="text/javascript">
	$(function(){
		$("#preschemePageForm").validationEngine();
	...
	function saveAction(){
		if($('#actionPageForm').find("[name=id]").val()==""){
			alert("请先保存预案信息");
			return;
		}
		if (confirm("确认要添加？")) {
			$('#actionPageForm').submit();
		}
	}
...
<body class="main_bg">
	<div class="win-header" id="a">
		<span class="win-header-title">业务管理 &gt; 预案管理 &gt; 添加预案</span>
	</div>
	<div class="win-bodyer">
		...
		<fieldset style="width: 90%;text-align: center">
		<legend>&nbsp;&nbsp;动作信息&nbsp;&nbsp;</legend>
		<form id="actionPageForm" name="pageForm" action="${ctx}/bussiness/prescheme!saveAction.do" method="post" >
			<input type="hidden" name="id" value="${preScheme.id}">
			<s:token/>
			<table class="inputTable" style="width: 100%" border="0">
				<tr>
				...
				<tr name="action_tr_record" class="action_tr" style="display: none">
					...
					<!--	<select name="actionObject.target" id="actionObject.target" onchange="changeChannel(this)">
							<option value="">请选择</option>
				...
				<tr>
					<td style="text-align:center;" colspan="4">
						<a class="a_button" href="javascript:void(0)" onclick="saveAction()"><span>添加</span></a>&nbsp;&nbsp;
