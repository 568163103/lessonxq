...
<script type="text/javascript">
	...
	function edit(id) {
		...
		$("#pageForm").attr("action","${ctx}/dmu/dmuAlarmLevel!beforeUpdate.do");
		$("#pageForm").submit();
	}
...
<body class="main_bg">
	<div class="win-header" id="a">
		<span class="win-header-title">网管管理 &gt; 告警级别 </span>
	</div>
	<div class="win-bodyer">
	<form id="pageForm" name="pageForm" action="${ctx}/dmu/dmuAlarmLevel!findPage.do" method="post">
