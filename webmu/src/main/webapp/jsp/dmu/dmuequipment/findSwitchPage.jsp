...
<script type="text/javascript">
	...
	function findSelect() {
		...
		$("#pageForm").attr("action","${ctx}/dmu/dmuSwitchPort!findPage.do");
		$("#pageForm").submit();
...
<body class="main_bg">
	...
	<form id="pageForm" name="pageForm" action="${ctx}/dmu/dmuEquipment!findSwitchPage.do" method="post">
				...
				<tfoot>
					...
					<tr>
						<td colspan="11" style="text-align: center;vertical-align: top;height: 35px">
							<a class="a_button" href="javascript:void(0);" onclick="return findSelect();"><span>端口信息</span></a>&nbsp;&nbsp;
