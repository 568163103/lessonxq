...
<body class="main_bg">
	<div class="win-header" id="a">
		<span class="win-header-title">交换机端口 &gt; 添加交换机端口</span>
	</div>
	<div class="win-bodyer">
	<form id="pageForm" name="pageForm" action="${ctx}/dmu/dmuSwitchPort!save.do" method="post">
		<s:token/>
		...
		<table width="90%" class="inputTable">
			...
			<tr>
				...
				<td width="20%"><input type="text" value="${switchPortInfo.port}" class="validate[required,custom[integer]]" name="port" id="port" maxlength="32"/></td>
				<td style="text-align: right;"><label class="field-request">* </label>远端IP地址：</td>
				<td><input type="text" value="${switchPortInfo.ip}" class="validate[required,custom[ipv4]]" name="ip" id="ip" /></td>
