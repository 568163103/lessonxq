...
<body class="main_bg">
	<div class="win-header" id="a">
		<span class="win-header-title">权限管理 &gt; 角色管理 &gt; 添加角色</span>
	</div>
	<div class="win-bodyer">
	<form id="pageForm" name="pageForm" action="${ctx}/security/role!save.do" method="post">
		<s:token/>
		<table class="inputTable" width="100%">
			<tr>
				<td style="text-align:right;">角色名称：</td>
				<td><input type="text" name="role.rname" id="role_rname" class="validate[required,ajax[checkUnique]]" maxlength="32"/></td>
			</tr>
			<tr>
