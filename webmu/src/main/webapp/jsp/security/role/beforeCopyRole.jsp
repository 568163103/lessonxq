...
<body class="main_bg">
	<div class="win-header" id="a">
		<span class="win-header-title">权限管理 &gt; 角色管理 &gt; 原角色 --- ${param.rolename}</span>
	</div>
	<div class="win-bodyer">
	<form id="pageForm" name="pageForm" action="${ctx}/security/role!copyRoleUP.do" method="post">
		<input type="hidden" id="srcrid" name="srcrid" value="${param.rid}">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			    <c:forEach var="role" items="${roles}" varStatus="status">
					...
					<tr>
						...
						<input type="radio" name="destrid" value="${role.rid}" />
						</td>
