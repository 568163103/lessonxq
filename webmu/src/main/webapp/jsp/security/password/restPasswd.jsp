...
<body class="main_bg">
	<form id="pageForm" name="pageForm" action="${ctx}/security/password!restPasswd.do" method="post">
		<div id="main" class="clearfix">
			...
			<div id="main2">
				<div class="m2_user">
					<span class="name">新&nbsp;&nbsp;密&nbsp;&nbsp;码：</span><input type="password" class="validate[required,minSize[6],maxSize[64],custom[eanRange]]" name="passwd" id="passwd" autocomplete="off"/>
				</div>
