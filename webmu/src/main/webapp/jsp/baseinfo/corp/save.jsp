...
<body class="main_bg">
	<div class="win-header" id="a">
		<span class="win-header-title">数据维护 &gt; 单位管理 &gt; 添加单位</span>
	</div>
	<div class="win-bodyer">
	<form id="pageForm" name="pageForm" action="${ctx}/baseinfo/corp!save.do" method="post">
		<s:token/>
		<table width="100%" class="inputTable">
			<tr>
				<td style="text-align: right;" width="18%"><label class="field-request">* </label>单位名称：</td>
				<td width="30%"><input type="text" value="${corp.cname}" class="validate[required,ajax[checkUnique]]" name="corp.cname" id="corp_cname" /></td>
