...
public class TRoleMenu extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = -6951155384044136734L;
	...
	public TRoleMenu(TRoleMenuId id, Short dmlflag, Date dmltime) {
		this.id = id;
