...
@Component("userTraceAction")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class UserTraceAction extends BaseAction {
	...
	public String findPage(){
		...
		userTraceBpo.findUserTrace(this.getPageObject());
		return "findPage";
	}
	
	public String exportList() {
		String filename = "操作日志导出("+ DateUtil.format("yyyyMMddHHmmss")+ ")";
		/** 处理中文 */
		try {
	...
	public InputStream getApendListInputStream() {  
		...
		/** 构造excel的数据内容 */
		ArrayList<ArrayList<String>> fieldData = userTraceBpo.findExcelFieldData(getPageObject());
