...
/**MAP格式
 * {"@command":"test","result":{"@code":"0","#text":"success"},"parameters":{"classs":[{"id":"001","name":"st001","student":{"id":"0001","name":{"first":"xue","last":"bo"}}},{"id":"001","name":"st001","student":{"id":"0001","name":{"first":"xue","last":"bo"}}}]}}
 * @author pc
 *
 */
public class XmlUtil {
	public static void main(String[] args) throws DocumentException, IOException { 
        ...
        String textFromFile = FileUtils.readFileToString(new File("E:/workspace/Query.xml"),"UTF-8");  
        ...
        System.out.println("=========");
        Document doc = map2xml(map,"request");  
