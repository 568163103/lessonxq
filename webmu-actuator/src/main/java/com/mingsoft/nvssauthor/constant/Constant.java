...
public class Constant {
    ...
    public final static String SERVER_TYPE_Master = "master";
     ...
     * 总容量
     */
     public static final String DISK_MEMORY_ALL = "1.3.6.1.4.1.3470.12.1.1.8.0";
    ...
    public static final String HW_ENTITY_CPU_USAGE ="1.3.6.1.4.1.2011.6.3.4.1.3";
