...
//        sendRequest(snmp, createGetPdu("1.3.6.1.2.1.1.3"), target);
    ...
    public static void sendCloudStorageAsyncRequest(Snmp snmp, PDU pdu, CommunityTarget target)
            throws IOException {
            ...
            public void onResponse(ResponseEvent event) {
                ...
                if (response == null) {
                    ...
                    if (response.getErrorStatus() == PDU.noError) {
                        Vector<? extends VariableBinding> vbs = response.getVariableBindings();
                        System.out.println(vbs);
//                        JSONObject cloudStorageInfo = JSON.parseObject(vbs.get(0).toValueString());
//
//                        JSONObject cloudStorageHardware = JSON.parseObject(vbs.get(1).toValueString());
//
//                        JSONArray jsonArrayCloudStorageInfo = cloudStorageInfo.getJSONArray("nodeList");
//
//                        JSONArray jsonArrayCloudStorageHardware = cloudStorageHardware.getJSONArray("nodeList");
//                        System.out.println("cloudStorageInfo"+cloudStorageInfo);
//                        List<JSONObject> jsonObjects = new ArrayList<>();
//                        for (int i = 0; i < jsonArrayCloudStorageInfo.size(); i++) {
//                            JSONObject temJsonObject = new JSONObject();
//                            System.out.println();
//                            if ("data".equals(jsonArrayCloudStorageInfo.getJSONObject(i).getString("nodeType")) || "storage".equals(jsonArrayCloudStorageInfo.getJSONObject(i).getString("nodeType"))) {
//                                temJsonObject.put("nodeIp", jsonArrayCloudStorageInfo.getJSONObject(i).getString("nodeIp"));
//                                temJsonObject.put("nodeType", jsonArrayCloudStorageInfo.getJSONObject(i).getString("nodeType"));
//                                temJsonObject.put("hostname", jsonArrayCloudStorageInfo.getJSONObject(i).getString("hostname"));
//                                temJsonObject.put("os", jsonArrayCloudStorageInfo.getJSONObject(i).getString("os"));
//                                temJsonObject.put("memoryCap", jsonArrayCloudStorageInfo.getJSONObject(i).getString("memoryCap"));
//                                temJsonObject.put("cpuModel", jsonArrayCloudStorageInfo.getJSONObject(i).getString("cpuModel"));
//                                temJsonObject.put("cpuCores", jsonArrayCloudStorageInfo.getJSONObject(i).getString("cpuCores"));
//                                temJsonObject.put("dsikFactory", jsonArrayCloudStorageInfo.getJSONObject(i).getString("dsikFactory"));
//                                temJsonObject.put("dsikAllCap", jsonArrayCloudStorageInfo.getJSONObject(i).getString("dsikAllCap"));
//                                for (int j = 0; j < jsonArrayCloudStorageHardware.size(); j++) {
//                                    if (jsonArrayCloudStorageInfo.getJSONObject(i).getString("nodeIp").equals(jsonArrayCloudStorageHardware.getJSONObject(j).getString("nodeIp"))) {
//                                        jsonArrayCloudStorageHardware.getJSONObject(j).getString("nodeIp");
//                                        jsonArrayCloudStorageHardware.getJSONObject(j).getString("nodeIp");
//                                        jsonArrayCloudStorageHardware.getJSONObject(j).getString("nodeIp");
//                                    }
//
